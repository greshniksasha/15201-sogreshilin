...
public class FilterParser {
    ...
    public static Filter[] parse(String fileName) throws FilterCreateException, FileNotFoundException, FilterNullPointerException {
        List<Filter> filtersList = new ArrayList<Filter>();

        for (ConfigIterator it = new ConfigIterator(fileName); it.hasNext(); ) {
            Filter filter = Factory.create(it.next());
